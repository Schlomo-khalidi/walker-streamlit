...
This portion of the code takes in user input through a form-based approach, where the user enters the number of vehicles involved in the accident, the number of casualties, the hour of the day the accident occurred, the type of collision, the age group of the driver, the sex of the driver, the education level of the driver, the service year of the vehicle, the day of the week the accident occurred, and the area of the accident.

The app then encodes the user inputs using an ordinal encoder, predicts the severity of the accident using a pre-trained machine learning model, and displays the prediction on the front-end.
Step 7: App.py - Webpage Aesthetics
We’re almost done with creating our app.py file! The last portion is to write down the project description and problem statement on the front end to showcase the project.
